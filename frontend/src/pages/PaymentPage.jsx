...
const PaymentPage = () => {
  ...
  const amountToPay = dues > 0 ? dues : 1000;
  ...
  if (isSuccess) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: '#f7fafc' }}>
        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} style={{ padding: '40px', backgroundColor: 'white', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', textAlign: 'center', maxWidth: '400px' }}>
          ...
          <button onClick={() => window.print()} style={{ padding: '10px 20px', margin: '10px', backgroundColor: 'var(--primary-color)', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Print Receipt</button>
          <button onClick={() => navigate('/resident')} style={{ padding: '10px 20px', margin: '10px', backgroundColor: '#e2e8f0', color: 'black', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Back to Dashboard</button>
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: '#f7fafc' }}>
      <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} style={{ padding: '40px', backgroundColor: 'white', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', textAlign: 'center', maxWidth: '400px', width: '100%' }}>
        <h2>Checkout</h2>
        ...
        <button onClick={() => navigate(-1)} style={{ marginTop: '20px', padding: '10px', width: '100%', backgroundColor: 'transparent', border: '1px solid #cbd5e0', color: '#4a5568', borderRadius: '6px', cursor: 'pointer' }}>Cancel</button>
      </motion.div>
    </div>
  );
};
